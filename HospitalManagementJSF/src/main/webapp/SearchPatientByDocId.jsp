...
<html>
<head>
    <title>Show Patients by Doctor ID</title>
    <style>
        @keyframes fadeInUp {
            0% {
                opacity: 0;
...
<div class="container">
    ...
    <h:form>
        <h:messages globalOnly="true" style="color:#b91c1c; font-weight:bold;" />

        <div class="form-group">
            <h:outputLabel for="doctorId" value="Doctor ID:" />
            <h:inputText id="doctorId" value="#{doctorController.doctorId}" />
            <br/><br/>
            <h:commandButton value="Search" action="#{doctorController.getPatientsByDoctorId}" />
        </div>
